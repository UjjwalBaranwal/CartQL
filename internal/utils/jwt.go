// Package utils provides utility functions for handling JSON Web Tokens (JWT) in the CartQL application, including token generation and validation for user authentication and authorization.
package utils
